...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LAYER_BASE] = LAYOUT(
  // QWERTY - Kept as a backup, LHS may be useful for gaming
  // ╭──────────────────────────────────────────────────────╮ ╭──────────────────────────────────────────────────────╮
  ...
  // ├──────────────────────────────────────────────────────┤ ├──────────────────────────────────────────────────────┤
       KC_TAB,    KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,       KC_K,    KC_H, KC_COMM,  KC_DOT, PT_SLSH,  KC_NO,
  // ╰──────────────────────────────────────────────────────┤ ├──────────────────────────────────────────────────────╯
...
// Function to change RGB lighting based on the active layer
// void set_layer_color(uint8_t layer) {
//     uint8_t current_brightness = rgblight_get_val();
//     switch (layer) {
//         case LAYER_NUM_MOUSE:
//             rgblight_setrgb(RGB_TEAL);
//             rgblight_sethsv(rgblight_get_hue(), rgblight_get_sat(), current_brightness);
//             break;
//         default:
...
// Override the layer_state_set_user function
// layer_state_t layer_state_set_user(layer_state_t state) {
